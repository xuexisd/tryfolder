...
#import "TVUnprocessedViewController.h"
...
@interface TVUnprocessedViewController ()

@end

@implementation TVUnprocessedViewController
{
...
-(void)BaseMBLoadData
{
    [self PostDataforUnprocessed];
    [self SerializationDataFromPost];
}

-(void)PostDataforUnprocessed
{
    ...
    NSURL *url = [NSURL URLWithString:[Global GetUrlAddressUnprocessed]];
...
{
    static NSString *cellname=@"UnprocessedInfoCell";
